...
export const useProductionData = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      toast({ title: 'Erreur de chargement', description: e.message || 'Impossible de charger les produits.', variant: 'destructive' });
    }
  };
  ...
  const fetchLines = async () => {
    try {
      ...
      toast({ title: 'Erreur de chargement', description: e.message || 'Impossible de charger les lignes de production.', variant: 'destructive' });
    }
  };
  ...
  const fetchTasks = async () => {
    try {
      ...
      toast({ title: 'Erreur de chargement', description: e.message || 'Impossible de charger les tâches.', variant: 'destructive' });
    }
  };
  ...
  const createProduct = async (product: any) => {
    try {
      ...
      toast({ title: 'Erreur de création', description: e.message || 'Impossible de créer le produit.', variant: 'destructive' });
      return false;
    }
  };
  ...
  const updateProduct = async (id: string, updates: any) => {
    try {
      ...
      toast({ title: 'Erreur de modification', description: e.message || 'Impossible de modifier le produit.', variant: 'destructive' });
      return false;
    }
  };
  ...
  const createLine = async (line: any) => {
    try {
      ...
      toast({ title: 'Erreur de création', description: e.message || 'Impossible de créer la ligne.', variant: 'destructive' });
      return false;
    }
  };
  ...
  const updateLine = async (id: string, updates: any) => {
    try {
      ...
      toast({ title: 'Erreur de modification', description: e.message || 'Impossible de modifier la ligne.', variant: 'destructive' });
      return false;
    }
  };
  ...
  const createTask = async (task: any) => {
    try {
      ...
      toast({ title: 'Erreur de création', description: e.message || 'Impossible de créer la tâche.', variant: 'destructive' });
      return false;
    }
  };
  ...
  const updateTask = async (id: string, updates: any) => {
    try {
      ...
      toast({ title: 'Erreur de modification', description: e.message || 'Impossible de modifier la tâche.', variant: 'destructive' });
      return false;
    }
  };
...
export const useProducts = () => {
  ...
  const deleteProduct = async (id: string) => {
    try {
      ...
      toast({ title: 'Erreur de suppression', description: e.message || 'Impossible de supprimer le produit.', variant: 'destructive' });
      return false;
    }
  };
...
export const useProductionLines = () => {
  ...
  const deleteLine = async (id: string) => {
    try {
      ...
      toast({ title: 'Erreur de suppression', description: e.message || 'Impossible de supprimer la ligne.', variant: 'destructive' });
      return false;
    }
  };
...
export const useProductionTasks = () => {
  ...
  const deleteTask = async (id: string) => {
    try {
      ...
      toast({ title: 'Erreur de suppression', description: e.message || 'Impossible de supprimer la tâche.', variant: 'destructive' });
      return false;
    }
  };
