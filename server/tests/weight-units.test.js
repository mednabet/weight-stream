 ...
 * 
 * Exécution : node tests/weight-units.test.js
 */
...
class WeightUnitsTestSuite {
  ...
  async testGetAllUnits() {
    await this.runTest('GET /weight-units - Récupérer toutes les unités', async () => {
      const { data, status, error } = await this.request('/weight-units');
  ...
  async testUpdateUnit() {
    await this.runTest('PUT /weight-units/:id - Mettre à jour une unité', async () => {
      ...
      const { data: units } = await this.request('/weight-units');
  ...
  async testDeleteUnit() {
    await this.runTest('DELETE /weight-units/:id - Supprimer une unité', async () => {
      ...
      const { data: unitsAfter } = await this.request('/weight-units');
  ...
  async testCreateUnitWithInvalidData() {
